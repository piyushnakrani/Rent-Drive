...
$sql="update tblbike set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,ModelYear=:modelyear where id=:id ";
...
<head>
	...
	<title>Rent&Drive | Admin Edit Vehicle Info</title>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT tblbike.*,tblbikebrand.BrandName,tblbikebrand.id as bid from tblbike join tblbikebrand on tblbikebrand.id=tblbike.VehiclesBrand where tblbike.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php $ret="select id,BrandName from tblbikebrand";
...
<div class="form-group">
<div class="col-sm-4">
Image 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage);?>" width="300" height="200" style="border:solid 1px #000">
