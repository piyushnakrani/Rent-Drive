...
<head>
	...
	<title>Rent&Drive |Admin Manage testimonials   </title>
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT tblusers.FullName,tblfeedback.UserEmail,tblfeedback.Testimonial,tblfeedback.PostingDate,tblfeedback.status,tblfeedback.id from tblfeedback join tblusers on tblusers.Emailid=tblfeedback.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
