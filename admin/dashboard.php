...
<head>
	...
	<title>Rent&Drive | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed car</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Total Car Bookings</div>
												</div>
											</div>
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed  Car Brands</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$sql4 ="SELECT id from tblbikebrand ";
$query4 = $dbh -> prepare($sql4);
$query4->execute();
$results4=$query4->fetchAll(PDO::FETCH_OBJ);
$bikebrand=$query4->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bikebrand);?></div>
													<div class="stat-panel-title text-uppercase">Listed Bike Brand</div>
												</div>
											</div>
											<a href="manage-bike-brand.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
										<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql8 ="SELECT id from tblbike ";
$query8= $dbh -> prepare($sql8);
$query8->execute();
$results8=$query8->fetchAll(PDO::FETCH_OBJ);
$bike=$query8->rowCount();
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($bike);?></div>
													<div class="stat-panel-title text-uppercase">Listed  Bike</div>
												</div>
											</div>
											<a href="manage-bike.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql7 ="SELECT id from tblbikebooking";
$query7= $dbh->prepare($sql7);
$query7->execute();
$results7=$query7->fetchAll(PDO::FETCH_OBJ);
$bikebooking=$query7->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bikebooking);?></div>
													<div class="stat-panel-title text-uppercase">Total Bike Bookings</div>
												</div>
											</div>
